...
public class WeaponShop : MonoBehaviour
{
	...
	void Start()
    {
        ...
        total_weapon = GameManagers.Ins.total_weapon;
		InitWeapon(weapon_index);
        next.onClick.AddListener(() => PreviousWeapon());
	}
	private void InitWeapon(int index)
    {
		...
		weapon = Instantiate(GameManagers.Ins.GetCurrenWeapon(weapon_index),parent.position,Quaternion.identity,parent);
